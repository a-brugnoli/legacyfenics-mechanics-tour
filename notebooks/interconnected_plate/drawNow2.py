...
class Plot3D( object ):
    def __init__( self, X, Y,  minZ, maxZ, X2, Y2, xlabel = None, ylabel = None,  zlabel = None, title = None ):
        ...
        formatter = '{:.1e}'
        self.ax.zaxis.set_major_formatter(plt.FuncFormatter(lambda x, _: formatter.format(x)))
    ...
    def drawNow2( self, Z, Z2, z2label=None ):
        ...
        self.tri_surf._facecolors2d = self.tri_surf._facecolor3d
        self.tri_surf._edgecolors2d = self.tri_surf._edgecolor3d
